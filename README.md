...
|---|------|--------|----------|
| ⭐ | **MR Osama Revision** (foundations) | `cursor/revision-mr-osama-8ef2` | `https://OSRoot.github.io/grade-eight-english/revision/` |
...
Enable Pages in **Settings → Pages → Source: `gh-pages` / `/ (root)`** once.

## ✨ Features

- Fully bilingual UI (English ↔ العربية), language toggle, RTL flip
- Responsive modern designs (mobile + desktop)
- Mini-games per section: drag-and-drop sort, memory match, fill-in, MCQs, antonym game, conjugator…
- Browser text-to-speech for letters, words, and listening tracks
- XP/level gamification with confetti and toasts
- Auto-saves all open answers in `localStorage`
- Final test mode (revision site) with timer, scoring, and grade summary
